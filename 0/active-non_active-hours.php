                ...
                <div class="col-md-12 p-0 ">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card mt-2">
                                <div class="card-body">
                                    <div class="title text-center"> Comparison of Motor Running vs Non-Running Hours</div>
                                    <div class="status text-center">Motor Status <span id="selcted_phase_txt"></span> : <strong>IoT Monitored</strong></div>
